...
namespace Demo.Audit.DynamicProxy
{
    ...
    public class AuditProxy
    {
        ...
        public static T Create<T>(Type interfaceType, T instance, InterceptionSettings settings = null) where T : class
        {
            T auditedInstance;
            // One interceptor per instance
            var interceptor = new AuditInterceptor()
            ...
            auditedInstance = Generator.CreateInterfaceProxyWithTarget(interfaceType, instance, new[] { interceptor }) as T;
